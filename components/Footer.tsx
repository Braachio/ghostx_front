      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-cyan-500/30 pb-4">
          <div className="flex items-center gap-3">
            <Image src="/logo/ghost-x-symbol.svg" alt="GPX Hub" width={24} height={24} className="dark:invert" />
            <div className="flex flex-col">
              <span className="font-semibold text-white bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">GPX Hub</span>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <div className="text-gray-500 text-sm">
            © 2025 GPX Hub. All rights reserved.
          </div>
