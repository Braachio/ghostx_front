            ...
            <div className="hidden md:flex items-center gap-3">
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-gray-800 rounded-lg shadow-xl border border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-2">
                    <Link href="/chat/competizione" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                    ...
                    <Link href="/chat/lemans" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                    ...
                    <Link href="/chat/iracing" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏆</span>
                      <div>
                    ...
                    <Link href="/chat/assettocorsa" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
                    ...
                    <Link href="/chat/gran-turismo7" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏁</span>
                      <div>
                    ...
                    <Link href="/chat/automobilista2" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
                    ...
                    <Link href="/chat/f1-25" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏁</span>
                      <div>
                    ...
                    <Link href="/chat/ea-wrc" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
