            ...
            <div className="hidden md:flex items-center gap-3">
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-gray-800 rounded-lg shadow-xl border border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-2">
                    <Link href="/events/regular/competizione/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                    ...
                    <Link href="/events/regular/lemans/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                    ...
                    <Link href="/events/regular/iracing/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏆</span>
                      <div>
                    ...
                    <Link href="/events/regular/assettocorsa/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
                    ...
                    <Link href="/events/regular/gran-turismo7/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏁</span>
                      <div>
                    ...
                    <Link href="/events/regular/automobilista2/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
                    ...
                    <Link href="/events/regular/f1-25/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏁</span>
                      <div>
                    ...
                    <Link href="/events/regular/ea-wrc/chat" className="block px-4 py-3 text-white hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-3">
                      <span className="text-lg">🏎️</span>
                      <div>
